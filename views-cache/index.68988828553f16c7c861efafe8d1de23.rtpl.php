<?php if(!class_exists('Rain\Tpl')){exit;}?><div class="slider-area">
    ...
    <div class="block-slider block-slider4">
        <ul class="" id="bxslider-home4">
            <li>
                <img src="/res/site/img/h4-slideR.png" alt="Slide">
                <div class="caption-group">
                    <h2 class="caption title">
                        Kit <span class="primary"> <strong>Festas</strong></span>
                    </h2>
                    <h4 class="caption subtitle">Dual SIM</h4>
                    <a class="caption button-radius" href="#"><span class="icon"></span>Comprar</a>
                </div>
            </li>
            <li><img src="/res/site/img/h4-slide2R.png" alt="Slide">
                <div class="caption-group">
                    <h2 class="caption title">Bolos, Tortas <span class="primary"> e <strong>muito mais</strong></span>
                    </h2>
                    <h4 class="caption subtitle">Acesse para mais opções</h4>
                    <a class="caption button-radius" href="#"><span class="icon"></span>Comprar</a>
                </div>
            </li>
            <li><img src="/res/site/img/h4-slide3R.png" alt="Slide">
                <div class="caption-group">
                    <h2 class="caption title">
                        Salgados Fritos <span class="primary">de Variados  <strong>Tipos</strong></span>
                    </h2>
                    <h4 class="caption subtitle">Acesse para mais opções</h4>
                    <a class="caption button-radius" href="#"><span class="icon"></span>Comprar</a>
                </div>
            </li>
            <li><img src="/res/site/img/h4-slide4R.png" alt="Slide">
                <div class="caption-group">
                    <h2 class="caption title">
                        Temos também <span class="primary">opções de <strong>Assados</strong></span>
                    </h2>
                    <h4 class="caption subtitle">Acesse para mais opções</h4>
                    <a class="caption button-radius" href="#"><span class="icon"></span>Comprar</a>
                </div>
